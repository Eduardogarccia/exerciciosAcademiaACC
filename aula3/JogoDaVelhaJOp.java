...
public class JogoDaVelhaJOp {
	...
	public static void Jogar(String [][] tabuleiro, String simbolo, String jogador) {
		int linha;
		int coluna;
		do { 	
		linha = Integer.parseInt(JOptionPane.showInputDialog("VEZ DO " + jogador + "\nDigite a linha"));

		coluna = Integer.parseInt(JOptionPane.showInputDialog("Digite a coluna"));
